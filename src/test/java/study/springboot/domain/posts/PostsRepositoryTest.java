...
public class PostsRepositoryTest {
    ...
    postsRepository.findAll
        테이블 posts에 있는 모든 테이터를 조회해오는 메소드
     */
    @Test
    public void importSavedContent(){
        //given
        String title = "테스트 게시글";
        String content = "테스트 본문";

        postsRepository.save(Posts.builder().title(title).content(content).author("de0309@gmail.com").build());
